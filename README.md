...
**NOT ready for production - wait for official release!**

Plugin to enable Amazon Neptune with Gremlin API database as a target in [Hackolade](https://hackolade.com) data modeling.  Requires prior download of the Hackolade application from our [download page](https://hackolade.com/download.html)
